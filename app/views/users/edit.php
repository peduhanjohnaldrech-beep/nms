...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="<?= APP_URL ?>/users/<?= $user['id'] ?>/edit" method="post">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="role" id="roleSelect" class="form-select" required>
                                ...
                                <option value="<?= $r ?>" <?= strtolower($user['role'] ?? '') === $r ? 'selected' : '' ?>><?= ucfirst($r) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="barangay" id="barangayInput" class="form-select">
                                ...
                                <option value="<?= htmlspecialchars($b['barangay']) ?>"
                                    <?= ($user['barangay'] ?? '') === $b['barangay'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="alert alert-info py-2 mb-0">
                            ...
                            Admin accounts have full access to everything and cannot be restricted.
                        </div>
                        <?php else: ?>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <div class="form-check border rounded p-2 ps-4 perm-item <?= in_array($key, $userPerms) ? 'bg-primary bg-opacity-10 border-primary' : '' ?>">
